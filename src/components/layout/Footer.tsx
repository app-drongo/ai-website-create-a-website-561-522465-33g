          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              <Link href="/" className="flex items-center space-x-2 mb-4">
                ...
                <span className="font-bold text-xl text-foreground">Test Site</span>
              </Link>
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                A minimal testing platform designed for modern development workflows. 
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">hello@testsite.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">123 Tech Street, Suite 100</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get the latest updates and insights. No spam, unsubscribe anytime.
              </p>
            </div>
          </div>
